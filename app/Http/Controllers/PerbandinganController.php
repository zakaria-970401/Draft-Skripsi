...
class PerbandinganController extends Controller
{
    ...
    public function perbandingan_data_bansos()
    {
        ...
        return view(
            'admin.analisa_data.perbandingan.data_bansos.index',
            compact(
                'ortu_lengkap_persen',
    ...
    public function perbandingan_data_training()
    {
        ...
        // dd($tdk_ada_sk_persen);
        return view(
            'admin.analisa_data.perbandingan.data_training.index',
            compact(
                'ortu_lengkap_persen',
                'ortu_tdklengkap_persen',
                'tanpa_ayah_persen',
