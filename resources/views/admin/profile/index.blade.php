...
@section('judul' , 'Halaman Profile Admin')
                ...
                <div class="col-xs-12 col-sm-3 center">
                    <div>
                        <span class="profile-picture">
                            <img id="avatar" class="editable img-responsive" alt="Foto Belum Ada" src="{{asset('foto_akunadmin/'.Auth::user()->foto)}}" style="100px" />
                        </span>
...
<div class="modal fade" id="modal-update" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="header smaller lighter blue">Edit Akun Admin</h3>
        <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            <img src="{{asset('foto_akunadmin/'.$admin->foto)}}" alt="Belum Ada Foto" readonly style="width:100px"/>
                            </div>
                        </div>
