        ...
        <div class="col-xs-10">
            @if($status->status == '1')
                    ...
                    <div class="col-xs-4">
                        ...
                        <a href="/admin/hapus_dataset_siswa/{{$status->id}}" class="btn btn-danger"> <i class="fa fa-trash"> Hapus Data</i></a>
                    </div>
                    <br>
                    <br>
                    <br>
        
                <form action="/admin/proses_dataset_siswa/{{$status->id}}" method="POST">
                        @csrf
...
<div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                    <!-- PAGE CONTENT BEGINS -->
                    <form action="/admin/update_dataset_siswa/{{$status->id}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-8">
...
<form action="/admin/tolak_dataset_siswa/{{$status->id}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
    @method('PATCH')
    {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="hidden" id="form-field-1-1" placeholder="Silahkan di isi" class="form-control" name="nisn" value="{{$status->nisn}}"/>
                     <input type="hidden" id="form-field-1-1" placeholder="Silahkan di isi" class="form-control" name="pemeriksa" value="{{Auth::user()->nama}}"/>
